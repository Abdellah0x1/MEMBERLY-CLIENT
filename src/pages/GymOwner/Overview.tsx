        ...
        <div className="p-4 sm:p-6 lg:p-8 w-full max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {stats.map((stat, i) => (
                    <motion.div
                        ...
                        className="relative group overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#12121a] p-6 hover:shadow-xl hover:shadow-neon/5 transition-all duration-300"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <motion.div
                    ...
                    className="lg:col-span-2 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#12121a] p-6 shadow-sm"
                >
                ...
                <motion.div
                    ...
                    className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#12121a] p-6 shadow-sm flex flex-col"
                >
