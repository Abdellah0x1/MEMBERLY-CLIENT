        ...
        <div className='w-full max-w-7xl mx-auto space-y-8'>
            ...
            <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
                ...
                <button 
                    ...
                    className='flex items-center gap-2 px-6 py-2.5 bg-neon text-black font-semibold rounded-xl hover:bg-neon/90 shadow-sm hover:shadow-md transition-all active:scale-95'
                >
                    <Plus size={20} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {filteredCoaches.map((coach, i) => (
                    <motion.div 
                        ...
                        key={coach.id} 
                        className="group relative bg-white dark:bg-[#12121a] border border-gray-200 dark:border-gray-800 rounded-3xl p-6 hover:shadow-lg hover:border-gray-300 dark:hover:border-gray-700 transition-all duration-300"
                    >
